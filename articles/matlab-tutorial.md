...
```
    ...
    ## Writing 1 ROI from D20230314T001205_IFCB134.roi to
    ## data/classified_images/Tripos_lineatus
...
### Visually Inspect and Correct Annotations

To visually inspect and correct annotations, use the
[`ClassiPyR`](https://europeanifcbgroup.github.io/ClassiPyR/) package,
which provides a dedicated image gallery application:

``` r

# install.packages("ClassiPyR")
ClassiPyR::run_app()
```
...
# Read a file with selected images (e.g., generated by ClassiPyR::run_app())

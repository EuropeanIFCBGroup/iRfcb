...
test_that("ifcb_py_install creates and uses the virtual environment", {
  ...
  mock_virtualenv_create <- mock()
  # Mock the use_virtualenv function
  mock_use_virtualenv <- mock()

  # Stub the virtualenv_create and use_virtualenv functions
  stub(ifcb_py_install, 'virtualenv_create', mock_virtualenv_create)
  stub(ifcb_py_install, 'use_virtualenv', mock_use_virtualenv)

  # Call the function
  ifcb_py_install(envname = "~/virtualenvs/iRfcb-test")
  ...
  expect_equal(args_virtualenv_create[[1]][[1]], "~/virtualenvs/iRfcb-test")

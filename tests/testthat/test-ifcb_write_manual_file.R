test_that("ifcb_write_manual_file creates and updates mat files as expected", {
  ...
  # Create a new file
  ifcb_write_manual_file(png_images = c("D20220522T003051_IFCB134_00002.png",
...
test_that("ifcb_write_manual_file handles errors gracefully", {
  # # Skip the test if Python environment is not available
  # skip_if_not(py_available(initialize = TRUE), "Python environment is not available")
  ...
  expect_error(ifcb_write_manual_file(png_images = c("D20220522T003051_IFCB134_00002.png",
                                                     "D20220522T003051_IFCB134_00003.png"),
                                      class = "Nodularia_spumigena",
                                      manual_folder = new_folder,
                                      adc_folder = manual_folder,
  ...
  # Expect error for non exisiting class
  expect_warning(ifcb_write_manual_file(png_images = c("D20220522T003051_IFCB134_00002.png",
                                                       "D20220522T003051_IFCB134_00003.png"),
                                        class = "Nodularia_spumigena",
                                        manual_folder = new_folder,
                                        adc_folder = manual_folder,

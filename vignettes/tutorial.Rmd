...
Images can be batch annotated using the [`ifcb_write_manual_file`](../reference/ifcb_write_manual_file.html) function. If a manual file already exists for the sample, the ROI class list will be updated accordingly. If no file is found, a new .mat file will be created, with all unannotated ROIs marked as unclassified.
...
# Print images to be annotated
print(correction$image_filename)

# Re-annotate the images
ifcb_write_manual_file(png_images = correction$image_filename,

...
By default, images are extracted with raw pixel values preserved from the camera, matching the output of IFCB Dashboard and other standard IFCB software. To stretch pixel values to the full 0-255 contrast range, set `normalize = TRUE`:
```{r, eval=FALSE}

...
```{r, include=FALSE}
# File to keep
keep_file <- file.path(data_dir, "48158716.zip")

# List all contents of data_dir (files + directories)
all_contents <- list.files(data_dir, full.names = TRUE, recursive = FALSE, include.dirs = TRUE)

# Exclude the file you want to keep
to_remove <- setdiff(all_contents, keep_file)

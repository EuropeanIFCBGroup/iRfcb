...
* Deprecate arguments `ifcb_count_mat_annotations(manual_folder = )`, `ifcb_extract_biovolumes(feature_folder = )`, `ifcb_extract_biovolumes(class_folder = )`, `ifcb_read_features(feature_folder = )` and `ifcb_summarize_biovolumes(class_folder = )`.

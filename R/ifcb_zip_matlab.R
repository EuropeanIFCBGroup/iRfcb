...
#' organized into a structured format suitable for distribution or storage. The MATLAB files
#' are generated by the ifcb-analysis repository.
#'
...
#' @export
#' @seealso \code{\link{zip_png_folders}} \url{https://github.com/hsosik/ifcb-analysis}

...
#'
#' The function requires v2 features generated by the `ifcb-analysis` MATLAB package
#' (Sosik and Olson 2007) found at \url{https://github.com/hsosik/ifcb-analysis}.
#'
#' @param feature_folder The absolute path to a directory containing all of the v2 feature
